...
function Home() {
  ...
  const [cameraError, setCameraError] = useState('');  // FIX: camera permission errors
  ...
  const handleRegister = async () => {
    // FIX: imgSrc is also checked here — button disabled handles it, but double-guard
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden -z-10">
        ...
        <div className="absolute top-[-10%] left-[-5%] w-96 h-96 bg-yellow-300 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob animation-delay-2000" />
      ...
      <div className="w-full max-w-lg bg-white/80 backdrop-blur-xl rounded-3xl p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-white/20">
        {mode === 'home' && (
          ...
          <div className="flex flex-col gap-5 animate-fadeIn">
            ...
            <div className="relative rounded-2xl overflow-hidden bg-gray-100 aspect-video flex items-center justify-center shadow-inner border border-gray-200">
              {imgSrc ? (
                ...
                // FIX: show a clear error when camera permission is denied
                <div className="flex flex-col items-center gap-2 p-6 text-center">
                  <span className="text-3xl">📷</span>
                  <p className="text-red-500 font-semibold text-sm">Camera access denied</p>
                ...
                <Webcam
                  ...
                  // FIX: handle webcam errors gracefully
            ...
            {mode === 'register' && !imgSrc && (
              <div className="space-y-4">
                ...
                <div className="flex gap-3">
                  ...
                  />
                  {/* FIX: placeholders now show expected format */}
                  <input
                    type="text"
                    placeholder="Height (175cm or 5'9&quot;)"
                    value={height}
                  ...
                  <input
                    type="text"
                    placeholder="Weight (70kg or 154lbs)"
                    value={weight}
            ...
            <div className="flex gap-3 mt-2">
              {!imgSrc ? (
                <button
                  ...
                  className="flex-1 bg-blue-500 hover:bg-blue-600 text-white py-3 rounded-xl font-bold shadow-md hover:shadow-lg transition-all hover:-translate-y-0.5 disabled:opacity-40 disabled:cursor-not-allowed"
                >
                  Capture
                </button>
              ) : (
                <>
                  ...
                  {mode === 'register' ? (
                    <button
                      ...
                      // FIX: disabled also checks !imgSrc explicitly
                      disabled={isLoading || !name || !age || !height || !weight || !imgSrc}
            ...
            {message && (
              <div
                className={`p-4 rounded-xl text-center font-medium shadow-sm ${
                  message.includes('Error') || message.includes('Unknown')
